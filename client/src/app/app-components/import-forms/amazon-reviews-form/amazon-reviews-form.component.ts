...
@Component({
  selector: 'app-amazon-reviews-form',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, AngularToastifyModule],
  templateUrl: './amazon-reviews-form.component.html',
  styleUrl: './amazon-reviews-form.component.css'
})
export class AmazonReviewsFormComponent {
  ...
  constructor(private formUtilsService: FormUtilsService, private toastService: ToastService,) {
    this.importForm = this.formUtilsService.initializeForm([
      ...
      { controlName: 'marketPlace', initialValue: 'com', validators: [Validators.required] },
      { controlName: 'productIDs', initialValue: '', validators: [Validators.required] },
      { controlName: 'tool', initialValue: 'amazon-review-v2' },
